...
public:
	...
	void Initialize()
	{
		...
		CreateParticleShape(GetFilePathByPlatform("../../data/bunny.ply").c_str(), Vec3(1.0f, 0.0f, 1.0f), 0.5f, 0.0f, s, Vec3(0.0f, 0.0f, 0.0f), m, true, 1.0f, NvFlexMakePhase(group++, 0), true, 0.0f);
		CreateParticleShape(GetFilePathByPlatform("../../data/box.ply").c_str(), Vec3(-3.0f, 0.0f, 5.0f), 0.1f, 0.0f, s, Vec3(0.0f, 0.0f, 0.0f), m, true, 1.0f, NvFlexMakePhase(group++, 0), true, 0.0f);
		CreateParticleShape(GetFilePathByPlatform("../../data/box.ply").c_str(), Vec3(3.0f, 0.0f, -3.0f), 0.1f, 0.0f, s, Vec3(0.0f, 0.0f, 0.0f), m, true, 1.0f, NvFlexMakePhase(group++, 0), true, 0.0f);
		CreateParticleShape(GetFilePathByPlatform("../../data/box.ply").c_str(), Vec3(3.0f, 0.0f,  5.0f), 0.1f, 0.0f, s, Vec3(0.0f, 0.0f, 0.0f), m, true, 1.0f, NvFlexMakePhase(group++, 0), true, 0.0f);
		...
		if (mDam)
		{
			...
			//CreateParticleGrid(Vec3(0.0f, 0.0f, 0.6f), 24, 24, 12, restDistance, Vec3(0.0f), 1.0f, false, 0.0f, NvFlexMakePhase(0, eNvFlexPhaseSelfCollide | eNvFlexPhaseFluid), 0.005f);
		...
		Emitter e1;
		e1.mDir = Vec3(0.0f, 0.0f, -1.0f);
		e1.mRight = Vec3(-1.0f, 0.0f, 0.0f);
		...
		// draw options		
		g_drawPoints = true;//false;
		g_drawEllipsoids = false;//true;
		g_drawDiffuse = true;
	}
