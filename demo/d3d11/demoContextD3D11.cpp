...
/// Interaction
void DemoContextD3D11::bindSolidShaderOculus(Vec3 lightPos, Vec3 lightTarget, Matrix44 lightTransform, ShadowMap* shadowMap, float bias, Vec4 fogColor,int width , int height)
{
	m_meshDrawParams.renderStage = MESH_DRAW_LIGHT;
...
/// INteraction
void DemoContextD3D11::drawGpuMesh2(GpuMesh* meshIn, const Matrix44& xform, const Vec4& color)
{
	if (meshIn)
	{
		GpuMeshD3D11* mesh = (GpuMeshD3D11*)meshIn;
...
/// Interaction
void DemoContextD3D11::initDrawPoints(unsigned int *idVBO, unsigned int *indicesVBO,int numParticles) {

}
///Interaction
void DemoContextD3D11::updatePoints(unsigned int idVBO, unsigned int indicesVBO, const float* particles, int* indices, int n) {

}
/// Interaction
void DemoContextD3D11::drawPoints(unsigned int idVBO, unsigned int indicesVBO, int n, int offset, float radius, float screenWidth, float screenAspect, float fov, Vec3 lightPos, Vec3 lightTarget, Matrix44 lightTransform, ShadowMap* shadowTex)
{
	
}
/// Interaction
void DemoContextD3D11::destroyDrawPoints(unsigned int *idVBO, unsigned int *indicesVBO) {
	
}

/// Interaction
void DemoContextD3D11::initDrawOculus(unsigned int *depthBufferID, unsigned int *renderTextureID, unsigned int * renderFrameBuffer, unsigned int *resolveTexture, unsigned int* resolveFrameBuffer, int nWidth, int nHeight) {

}
/// Interaction
void DemoContextD3D11::drawOculus(unsigned int  renderFrameBuffer, unsigned int resolveTexture, unsigned int resolveFrameBuffer, int w, int h, float *matrix) {

}
/// Interaction
void DemoContextD3D11::finDrawOculus(unsigned int  renderFrameBuffer, unsigned int resolveTexture, unsigned int resolveFrameBuffer, int w, int h, float *matrix) {

}
/// Interaction
void DemoContextD3D11::destroyDrawOculus(unsigned int *depthBufferID, unsigned int *renderTextureID, unsigned int * renderFrameBuffer, unsigned int *resolveTexture, unsigned int* resolveFrameBuffer) {
