...
/// Interaction
void DemoContextD3D12::initDrawPoints(unsigned int *idVBO, unsigned int *indicesVBO, int numParticles) {

}
///Interaction
void DemoContextD3D12::updatePoints(unsigned int idVBO, unsigned int indicesVBO, const float* particles, int* indices, int n) {

}

/// Interaction
void DemoContextD3D12::drawPoints(unsigned int idVBO, unsigned int indicesVBO, int n, int offset, float radius, float screenWidth, float screenAspect, float fov, Vec3 lightPos, Vec3 lightTarget, Matrix44 lightTransform, ShadowMap* shadowTex)
{

}
/// Interaction
void DemoContextD3D12::destroyDrawPoints(unsigned int *idVBO, unsigned int *indicesVBO) {

}

/// Interaction
void DemoContextD3D12::initDrawOculus(unsigned int *depthBufferID, unsigned int *renderTextureID, unsigned int * renderFrameBuffer, unsigned int *resolveTexture, unsigned int* resolveFrameBuffer, int nWidth, int nHeight) {

}
/// Interaction
void DemoContextD3D12::drawOculus( unsigned int  renderFrameBuffer, unsigned int resolveTexture, unsigned int resolveFrameBuffer, int w, int h, float *matrix) {

}
/// Interaction
void DemoContextD3D12::finDrawOculus(unsigned int  renderFrameBuffer, unsigned int resolveTexture, unsigned int resolveFrameBuffer, int w, int h, float *matrix) {

}
/// Interaction
void DemoContextD3D12::destroyDrawOculus(unsigned int *depthBufferID, unsigned int *renderTextureID, unsigned int * renderFrameBuffer, unsigned int *resolveTexture, unsigned int* resolveFrameBuffer) {
...
/// Interaction
void DemoContextD3D12::bindSolidShaderOculus(FlexVec3 lightPos, FlexVec3 lightTarget, Matrix44 lightTransform, ::ShadowMap* shadowMap, float bias, FlexVec4 fogColor,int width, int height)
{
	MeshDrawParamsD3D& params = m_meshDrawParams;
...
void DemoContextD3D12::drawGpuMesh2(GpuMesh* m, const Matrix44& xform, const FlexVec4& color)
{
	if (m)
	{
		MeshDrawParamsD3D params(m_meshDrawParams);
