...
/// Interaction
NV_FLEX_API NvFlexExtAsset* NvFlexExtCreateSoftFromVoxel(const float* voxeles, int numVoxeles, float clusterSpacing, float clusterRadius, float clusterStiffness, float linkRadius, float linkStiffness, float globalStiffness, float clusterPlasticThreshold, float clusterPlasticCreep);
